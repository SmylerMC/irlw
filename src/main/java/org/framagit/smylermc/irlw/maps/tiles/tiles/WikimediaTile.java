...
public class WikimediaTile extends RasterWebTile {
	...
	public URL getURL() {
		...
		try {
			...
			IRLW.logger.error("Generated an invalid URL for a map tile. This should not happend and is likely to crash the game. Please tell the dev at " + IRLW.AUTHOR_EMAIL);
